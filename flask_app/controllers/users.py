...
def dashboard():
    ...
    return render_template('dashboard.html', pies = pies, loggedUser=loggedUser, votedpies = loggedUserVotedPies)
...
def pies():
    ...
    pies = Pie.get_all()
    loggedUserVotedPies = User.get_user_voted_pies(data)
    return render_template('pies.html', pies = pies, loggedUser=loggedUser, votedpies = loggedUserVotedPies)
